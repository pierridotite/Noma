...
* [ ] **Backward Pass:** Implementing reverse-mode automatic differentiation for scalars.
* [ ] **Optimization Loop:** Generating code that updates variables based on gradients.
